...
def invokeBatchExecutionService():
    ...
    api_key = "ke+tPtPHrKXw4hwjoJOp76ZcIc27fBO/HPtdePKUqW720ygjxIZBVdZJrb7T9K2xHyeYjal7KdREn1XbrXPojw==" # Replace this with the API key for the web service
    url = "https://ussouthcentral.services.azureml.net/workspaces/13a9ddfe79eb4f84bab53d2d78a0fefa/services/c772cb69189246b48652146e5642db5a/jobs"



    uploadFileToBlob("training_non_user.csv", # Replace this with the location of your input file
                     "training_non_userblob.csv", # Replace this with the name you would like to use for your Azure blob; this needs to have the same extension as the input file 
    ...
    payload =  {
        ...
        "Inputs": {
            ...
            "input1": { "ConnectionString": connection_string, "RelativeLocation": "/" + storage_container_name + "/training_non_userblob.csv" },
        },     

        "Outputs": {

            "output1": { "ConnectionString": connection_string, "RelativeLocation": "/" + storage_container_name + "/training_non_userresults.ilearner" },

            "output2": { "ConnectionString": connection_string, "RelativeLocation": "/" + storage_container_name + "/training_non_userresults.csv" },
        },
        "GlobalParameters": {
}
    }
